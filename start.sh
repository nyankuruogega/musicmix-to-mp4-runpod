...
# Make NVIDIA encoder libs visible before testing NVENC
...
2. DESCRIPTION: Write one complete YouTube video description that includes:
   ...
   - A line encouraging viewers to like, subscribe and turn on notifications
...
print(f"[Encoder] Using: {VIDEO_ENCODER} ({'GPU' if USING_GPU else 'CPU'})", flush=True)
